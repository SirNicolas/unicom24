...
from .models import UserProfile, CreditProposal, Offer, ClientForm
...
class CreditProposalAdmin(admin.ModelAdmin):
    ...
    list_display = ['date_created', 'date_sent', 'statuses', 'offer',
                    'client_form']
...
class OfferAdmin(admin.ModelAdmin):
    ...
    list_display = ['date_created', 'date_changed', 'rotation_date_begin',
                    'rotation_date_end', 'offer_name', 'offer_types',
                    'min_score', 'max_score', 'credit_organization']
...
class ClientFormAdmin(admin.ModelAdmin):
    list_display = ['date_created', 'date_changed', 'family_name',
                    'name', 'father_name', 'birth_date', 'partner',
